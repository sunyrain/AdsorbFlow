...
def get_success_from_dft_valood(traj_path, dft_targets):
    with open(
        "oc20_dense/oc20dense_ref_energies.pkl",
        "rb",
    ) as f:
...
#     with open(
#         "oc20_dense/dft_val_minE_old.pkl", "wb"
#     ) as f:
    ...
    for system in targets:
        ...
        for adslab in targets[system]:
            if adslab[1] < minE:
                ...
                minE = adslab[1]
        traj = ase.io.read(
            f"oc20_dense/dft_val_trajectories/{system}/{system}_{dft_data[system]}.traj"
        )
        dft_data[system] = traj.get_positions()
    with open(
        "oc20_dense/dft_val_minE_pos.pkl",
        "wb",
    ) as f:
        pickle.dump(dft_data, f)
    return dft_data
...
if __name__ == "__main__":
    # traj_path = "relax_opt/com_sde/rel_only_z0_test"
    # traj_path = "relax_opt/eqv2_relaxations/rand1_I0.1_fmax0.01_allmd"
    # traj_path = "relax_opt/overfit_sde/pretrain-bysigma_lmdbcorr2-overfit_std0.1-10_numstep50_sample1"
    # traj_path = "relax_opt/val44_baseline/noisybfgs/val44_std-schedule1_xyads_wrandrots_NS10"
    # traj_path = "relax_opt/vasp/gnoc/rand1_I1"
    traj_path = "0/relaxations"
    # traj_path = "relax_opt/valood_baseline/R1I0.1"
    # traj_path = "relax_opt/val44_baseline/w_rot/is2rs_conditional/relaxations"
    print(traj_path.split("/")[-1])

    npz_path = "relax_opt/lmdbs/randheur100_I0.1_fmax0.03/eq2_23M_2M/results/2023-10-13-16-53-20/s2ef_predictions.npz"
    # get DFT targets
    dft_target_path = "oc20_dense_mappings/oc20dense_targets.pkl"
    if not Path(dft_target_path).exists():
        ...
        with open(dft_target_path, "rb") as f:
            dft_targets = pickle.load(f)
    # dft_target_pos_path = "oc20_dense/dft_val_minE_pos.pkl"
    # tag_path = (
    #     "oc20_dense_mappings/oc20dense_tags.pkl"
    # )
    ...
    # get_success_from_pkl("oc20_dense/results.pkl", dft_targets)
    ...
    # parallelized_adwt("relax_opt/relaxations_fmax0.01/densetrain-diff_low0.01_high5_numstep20*50_lr1e-6", -1)
