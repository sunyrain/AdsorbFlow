...
# 参考能量和目标文件路径
REF_ENERGIES_PATH = "/root/autodl-tmp/AdsorbFlow/oc20_dense_mappings/oc20dense_ref_energies.pkl"
TARGETS_PATH = "/root/autodl-tmp/AdsorbFlow/oc20_dense_mappings/oc20dense_targets.pkl"
